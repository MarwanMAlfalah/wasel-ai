...
export async function extractWithMock(
  ...
  const agreementTone = /(ممتاز|تمام|متفقين|أهلًا|اهلا|الله يعافيك|يعطيك العافية)/.test(
    normalized,
  )
    ? "نبرة الاتفاق ودية ومهنية، والكلام بين الطرفين مريح وواضح."
    : "نبرة الاتفاق عملية ومهنية وتميل للوضوح المباشر.";

  const followUpStyle =
    urgency === "عالية"
      ? "متابعة مباشرة ومحترمة مع تذكير واضح بالمبلغ وموعد السداد"
      : "تذكير لطيف بلهجة مهنية خفيفة مع توضيح المبلغ المتبقي";
